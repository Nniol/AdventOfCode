...
class Monkey():
    ...
    def __init__(self,starting_items:list[int],operation:str,test:int,pass_to_monkey:tuple,do_modulo:bool = False) -> None:
        ...
        self._inspects = 0
        self._do_modulo = do_modulo
        self._supermod = 0

    def has_items(self):
        return len(self._items) != 0

    def set_supermod(self,supermod):
        self._supermod = supermod
