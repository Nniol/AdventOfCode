...
test_monkeys:dict[int,Monkey] = {
    0: Monkey([79, 98],"old * 19",23,(3,2)),
    1: Monkey([54, 65, 75, 74],"old + 6",19,(0,2)),
    2: Monkey([79, 60, 97],"old * old",13,(3,1)),
    3: Monkey([74],"old + 3",17,(1,0))
}

real_monkeys:dict[int,Monkey] = {
    0: Monkey([99, 63, 76, 93, 54, 73],"old * 11",2,(1,7)),
    1: Monkey([91, 60, 97, 54],"old + 1",17,(2,3)),
    2: Monkey([65],"old + 7",7,(5,6)),
    3: Monkey([84, 55],"old + 3",11,(6,2)),
    4: Monkey([86, 63, 79, 54, 83],"old * old",19,(0,7)),
    5: Monkey([96, 67, 56, 95, 64, 69, 96],"old + 4",5,(0,4)),
    6: Monkey([66, 94, 70, 93, 72, 67, 88, 51],"old * 5",13,(5,4)),
    7: Monkey([59, 59, 74],"old + 8",3,(3,1))
}

monkeys:dict[int,Monkey] = test_monkeys
